...
class MainActivity : AppCompatActivity() {
    ...
    private val API = "3207f0a42abad4c12c25ecf315555707"

    private lateinit var errorButton: Button

    private lateinit var relativeLayoutZip: RelativeLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        relativeLayoutZip = findViewById(R.id.rlZip)
        ...
        buttonZip.setOnClickListener {
            ...
            relativeLayoutZip.isVisible = false
        }
    ...
    private suspend fun updateWeatherData(result: String){
        withContext(Main){
            ...
            findViewById<TextView>(R.id.address).setOnClickListener {
                relativeLayoutZip.isVisible = true
            }
            findViewById<TextView>(R.id.updated_at).text =  lastUpdateText
            ...
            findViewById<TextView>(R.id.about).setOnClickListener { requestAPI() }
        }
    }
